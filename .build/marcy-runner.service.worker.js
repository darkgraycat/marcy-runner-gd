...
/** @type {string} */
const CACHE_VERSION = '1743917629|84130509351';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["marcy-runner.html","marcy-runner.js","marcy-runner.offline.html","marcy-runner.icon.png","marcy-runner.apple-touch-icon.png","marcy-runner.worker.js","marcy-runner.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["marcy-runner.wasm","marcy-runner.pck"];
