...
/** @type {string} */
const CACHE_VERSION = '1758999896|27092100';
/** @type {string} */
const CACHE_PREFIX = 'marcy-runner-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'marcy-runner.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["marcy-runner.html","marcy-runner.js","marcy-runner.offline.html","marcy-runner.icon.png","marcy-runner.apple-touch-icon.png","marcy-runner.audio.worklet.js","marcy-runner.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["marcy-runner.wasm","marcy-runner.pck"];
